...
const ContactEnPage = () => (
  <div className="min-h-screen bg-background">
    ...
    {/* Hero compact */}
    <section
      className="relative flex items-end justify-start overflow-hidden pt-32 pb-24 lg:pb-32 min-h-[50vh]"
      style={{
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-base md:text-lg font-heading font-bold uppercase tracking-tight text-foreground mb-3">
                  Real humans. In our office. 8am – 8pm.
                </h3>
                <p className="text-muted-foreground leading-relaxed">
                  Our offices are open Monday to Friday, 8:00 – 20:00 (UTC+1).
                </p>
                <p className="text-muted-foreground leading-relaxed mt-2">
                  You will always find us in our offices, ready to assist you during business hours.
                </p>
              </div>
