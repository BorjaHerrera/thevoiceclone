...
const sections: {
...
}[] = [
  {
    ...
    title:
      'Professional translation: scalability with terminological consistency',
...
const ProfessionalTranslationPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              We guarantee that your global communication maintains its original
              precision and impact in every market. We do not rely on
              uncontrolled automatic engines: we combine AI-assisted technology
              with the review of native experts to ensure uniform terminology
              and impeccable cultural adaptation.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                Your brand identity{' '}
                <GradientText>protected in every language.</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Many companies risk their reputation with automatic translations
                that lack context and corporate style. At The Voice Clone, our
                hybrid workflow unifies technological speed with human
                judgement, achieving 95% terminological consistency and
                eliminating common errors that generic tools typically overlook.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Intelligent translation and human review: maximum efficiency
                without AI errors.
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Optimise your budgets for{' '}
                <strong>
                  technical documentation, marketing campaigns and international
                  web content
                </strong>
                . Our methodology reduces terminological errors by up to 40%
                through the use of centralised glossaries and expert
                supervision, allowing you to scale your global presence without
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              Where translation becomes a{' '}
              <GradientText>trust asset.</GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Internal management of translations often leads to inconsistencies
              that damage brand image. By trusting our managed service, you
              access a professional translation infrastructure that guarantees
              consistency, speed and operational savings. We scale your
              communications quickly so your message reaches any market with
              maximum reliability.
            </p>
          </motion.div>
        </div>
      ...
      <VideoPortfolio
        videoIds={['yDDZg_Qh4Rs', 'lHSTqk_1uc4', 'Ohr6Kw1Qmx0']}
      />
