...
const AudiovisualLocalizationPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              We integrate translation, subtitling, dubbing and cultural
              adaptation under a single managed workflow. We enable global
              companies to adapt their multimedia content to multiple languages
              without losing brand consistency or operational efficiency,
              combining AI assistance and human review to guarantee quality and
              speed on critical projects.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                ...
                <GradientText>
                  AUDIOVISUAL AND E-LEARNING LOCALIZATION
                </GradientText>
              </h2>
            </motion.div>
            <motion.div
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                At The Voice Clone we comprehensively manage the localization of
                corporate videos, e-learning training, voice over and subtitles,
                avoiding consistency errors and reducing costs. We implement the
                benefits of end-to-end workflows and hybrid AI + human solutions
                to transform your global communication and generate qualified
                B2B results with total clarity and professional control.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Multimedia AI solutions: video, audio, subtitling and
                translation
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Intelligent multimedia localization transforms corporate
                communication by integrating video, audio and text into a
                culturally adapted workflow that far surpasses traditional
                translation. Through the use of hybrid solutions that combine
                the agility of AI with the precision of human supervision,
                companies achieve impeccable brand consistency in marketing and
                training, guaranteeing professional subtitles and dubbing that
                meet accessibility standards and maintain maximum tonal
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              We offer total control to adapt your assets to multiple languages
              and cultures. By centralising workflows, you not only reduce costs
              and operational friction, but also ensure professional brand
              consistency. It is the ideal solution for companies that need to
              scale training programmes and global communication with maximum
              confidence and professional finish.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <VideoPortfolio
        videoIds={['wyMLE_um2Sk', 'lHSTqk_1uc4', 'yDDZg_Qh4Rs']}
      />
