...
const VideoForBusinessPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              With The Voice Clone you will discover how our hub centralises the
              creation, localization and distribution of global audiovisual
              content. Every service — from corporate and training videos to
              e-learning courses, AI video generation and multilingual content —
              is designed to optimise workflows, maintain brand consistency and
              accelerate the international expansion of your audiovisual
              content.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                THE NEW PARADIGM IN{' '}
                <GradientText>VIDEO PRODUCTION AND LOCALIZATION.</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Transform the way your company communicates globally. At The
                Voice Clone, we combine advanced AI technology with human
                supervision to produce and localize audiovisual content at
                scale. Whether by adapting training courses or creating videos
                with intelligent avatars, our hub guarantees efficient
                processes, fast deliveries and a multilingual presence without
                friction or consistency failures.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              ...
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                We generate efficient, consistent and multilingual audiovisual
                content. By combining avatar technology with expert
                localization, we allow your brand to scale its corporate and
                training communications with maximum agility and rigorous
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Scalability strategies: centralised workflows that allow total
              control over each video version. AI templates and automation to
              maintain consistency and speed. Production KPI monitoring and
      ...
      <VideoPortfolio
        videoIds={['wyMLE_um2Sk', 'tbD-8HViFl4', 'Ohr6Kw1Qmx0']}
      />
