      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              Impulsa la accesibilidad y la internacionalización de tus vídeos
              corporativos. No utilizamos herramientas automáticas sin control:
              gestionamos un proceso integral que combina precisión lingüística,
              adaptación cultural y revisión experta para proteger la identidad
              de tu marca en cada mercado.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                Calidad profesional en cada línea:{' '}
                <GradientText>
                  Olvídate de los errores de la automatización pura.
                </GradientText>
              </h2>
            </motion.div>
            <motion.div
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Muchas empresas dependen de generadores automáticos que producen
                errores de sincronización y terminología. En The Voice Clone,
                nuestro flujo híbrido asegura que el subtitulado no sea solo un
                proceso técnico, sino una adaptación fiel que respeta el
                contexto cultural y los estándares internacionales de
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Precisión lingüística con rapidez IA. Máxima eficiencia en tu
                contenido global.
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Escala tu comunicación audiovisual con una solución que optimiza
                tiempos y presupuestos en{' '}
                <strong>
                  vídeos corporativos, e-learning y campañas de marketing
                </strong>
                . Nuestra metodología permite reducir drásticamente los costes
                de producción manteniendo una precisión milimétrica en los
                tiempos y el lenguaje, sin necesidad de inversión inicial en
                infraestructura.
              </p>
              <div
            ...
            <div className='hidden lg:block'>
              <div className='sticky top-40 self-start'>
                <h2 className='text-4xl font-heading font-extrabold uppercase leading-tight text-foreground mb-12'>
                  Un modelo que une tecnología de vanguardia y rigor
                  lingüístico.
                </h2>
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              The Voice Clone: Donde el subtitulado se convierte en una{' '}
              <GradientText>ventaja estratégica.</GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Producir subtítulos internamente implica errores técnicos y costes
              ocultos. Al confiar en nuestro servicio gestionado, obtienes
              activos de vídeo listos para su publicación global con costes
              optimizados. Transformamos el subtitulado en una herramienta de
              internacionalización potente, eliminando la fricción operativa y
              asegurando resultados profesionales certificados.
            </p>
          </motion.div>
        </div>
      </section>
