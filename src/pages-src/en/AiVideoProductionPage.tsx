      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              We create corporate and advertising videos with AI combining
              advanced technology and human supervision to scale content on web,
              social media and advertising without losing quality or brand
              consistency. Video production is today one of the most effective
              assets for building trust and increasing conversion; by
              integrating AI, we achieve greater speed, more versions and lower
              operational costs.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                CORPORATE VIDEO PRODUCTION FOR{' '}
                <GradientText>WEB, SOCIAL MEDIA AND ADVERTISING</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Audiovisual production improves digital presence at every
                touchpoint, from the corporate website to advertising campaigns.
                Thanks to AI, it is possible to communicate complex messages
                clearly, adapt content to different formats without redoing
                production and maintain a homogeneous visual identity even with
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                AI audiovisual production: cutting-edge technology with expert
                supervision
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Our production combines strategic visual narrative, motion
                graphics and AI-generated elements such as avatars or automated
                scenes. The goal is to build a consistent and recognisable
                visual presence in all markets, translating brand identity into
                a visual language adaptable to multiple platforms.
              </p>
              <div
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              ...
              <GradientText>
                Scalability, savings and certified quality
              </GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Centralising your production with us allows accessing advanced AI
              technology without upfront investment, freeing internal resources
              while guaranteeing absolute brand consistency across all your
              channels. By combining centralised management with localization
              and multilingual content solutions, we transform video production
              into a real competitive advantage: you will scale your
              communications quickly, dramatically reduce operational costs and
              always obtain a professional result adapted to any international
              market.
            </p>
          </motion.div>
        </div>
