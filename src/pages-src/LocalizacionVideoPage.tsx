...
const videoLocalization =
  typeof videoLocalizationSrc === 'string'
    ? videoLocalizationSrc
    : (videoLocalizationSrc as { src: string }).src;
...
const LocalizacionVideoPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              La localización de vídeo permite a las compañías internacionales
              adaptar sus activos, desde formación corporativa hasta
              comunicación interna, a cualquier idioma y región. Al combinar
              doblaje, subtítulos y adaptación cultural con workflows asistidos
              por IA, las organizaciones logran una expansión eficiente,
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                LOCALIZACIÓN DE VÍDEO PARA{' '}
                <GradientText>FORMACIÓN y ELEARNING</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                The Voice Clone optimiza el ciclo completo de localización:
                desde el doblaje de cursos de e-learning hasta el subtitulado
                inteligente y la producción asistida por IA. Centraliza tus
                procesos para reducir costes, garantizar la coherencia de marca
          ...
          >
            <div className='max-w-2xl'>
              ...
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                La localización de vídeo va más allá de la traducción: adapta
                voces, subtítulos y elementos visuales para conectar
                culturalmente con cada región. Mediante un modelo híbrido de{' '}
                <strong>IA y revisión humana</strong>, garantiza una expansión
                global rápida sin sacrificar la identidad de marca ni la
                precisión cultural.
              </p>
              <div
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              Localización de vídeo asistida por IA con{' '}
              <GradientText>supervisión humana</GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              El equilibrio perfecto para escalar: la tecnología aporta la
              velocidad para globalizar contenidos, mientras que el experto
              humano asegura la coherencia de marca y la relevancia cultural
              necesaria para que el mensaje impacte de verdad.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <VideoPortfolio
        videoIds={['S17marPSB8g', 'lHSTqk_1uc4', 'wyMLE_um2Sk']}
      />
