...
import PoliticaCookiesPage from '@/pages-src/PoliticaCookiesPage'
...
export default function Page({ seo }: Props) {
  const defaults = pageSeoDefaults['/politica-cookies']
...
export const getServerSideProps: GetServerSideProps = async () => {
  const seo = await getSeoByUri('/politica-cookies/')
  return { props: { seo } }
}
