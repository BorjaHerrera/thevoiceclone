...
const voiceoverImg =
  typeof voiceoverImgSrc === 'string'
    ? voiceoverImgSrc
    : (voiceoverImgSrc as { src: string }).src;
...
const sections = [
  ...
  },
  {
    ...
    title:
      'Metodología híbrida: el equilibrio entre IA y locutores profesionales',
...
const VocesIAPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              Escalamos tu producción de contenido sin perder calidad ni
              coherencia de marca. No somos un generador automático: gestionamos
              todo el proceso, desde la revisión estratégica del guion hasta la
              masterización final. El resultado es una locución profesional,
              eficiente y totalmente alineada con tu identidad corporativa.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                ...
                <GradientText>tu voz suene perfecta.</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Olvídate de configurar parámetros. Muchas compañías confunden
                los generadores automáticos con un servicio profesional.
                Mientras un software solo produce un archivo de audio, nuestro
                flujo híbrido adapta, refina e integra cada voz dentro de tu
                estrategia global. En The Voice Clone unificamos tecnología
                avanzada con edición humana para garantizar credibilidad,
                naturalidad y un ahorro operativo real.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Velocidad IA con rigor humano. Máxima eficiencia en tus
                locuciones
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Escala tu producción audiovisual con una solución que optimiza
                tiempos y presupuestos en vídeos corporativos, explicaciones de
                producto y comunicación internacional. Nuestra tecnología de
                síntesis de voz, validada por expertos, permite reducir
                drásticamente los costes de estudio en contenido para e-learning
                y formación interna, garantizando una coherencia de marca
                absoluta sin inversión inicial en infraestructura.
              </p>
              <div
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              The Voice Clone: Donde la IA se convierte en{' '}
              <GradientText>locución profesional.</GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Gestionar voces internamente implica curvas de aprendizaje y
              costes técnicos. Al confiar en nuestro servicio gestionado,
              accedes a tecnología de vanguardia y flujos estructurados con
              costes predecibles. Transformamos la producción de audio en una
              ventaja competitiva: escalarás tu comunicación rápidamente,
              reducirás la complejidad operativa y obtendrás siempre un
      ...
      <VideoPortfolio
        videoIds={['gWnV2XRaUv0', 'QeDAESHmZBU', 'lHSTqk_1uc4']}
      />
