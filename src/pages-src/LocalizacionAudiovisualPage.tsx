...
const localizacionAudiovisual =
  typeof localizacionAudiovisualSrc === 'string'
    ? localizacionAudiovisualSrc
    : (localizacionAudiovisualSrc as { src: string }).src;
...
const sections = [
  {
    ...
    title:
      'El valor de la localización híbrida: La potencia de la IA con garantía humana',
  ...
  },
  {
    ...
    title:
      'Localización profesional certificada: Calidad humana y eficiencia IA',
    navLabel:
      'Localización profesional certificada: Calidad humana y eficiencia IA',
    intro:
...
const LocalizacionAudiovisualPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              Integramos traducción, subtitulado, doblaje y adaptación cultural
              bajo un único workflow gestionado. Permitimos a las empresas
              globales adaptar su contenido multimedia a múltiples idiomas sin
              perder coherencia de marca ni eficiencia operativa, combinando IA
              asistida y revisión humana para garantizar calidad y rapidez en
              proyectos críticos.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                GESTIÓN INTEGRAL DE{' '}
                <GradientText>
                  LOCALIZACIÓN AUDIOVISUAL Y E-LEARNING
                </GradientText>
              </h2>
            </motion.div>
            <motion.div
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                En The Voice Clone gestionamos de manera integral la
                localización de vídeos corporativos, formación e-learning,
                voice-over y subtítulos, evitando errores de consistencia y
                reduciendo costes. Implementamos beneficios de workflows
                end-to-end y soluciones híbridas IA + humanos para transformar
                tu comunicación global y generar resultados B2B calificados con
                total claridad y control profesional.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Soluciones Multimedia con IA: Vídeo, audio, subtitulado y
                traducción
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                La localización multimedia inteligente transforma la
                comunicación corporativa al integrar vídeo, audio y texto en un
                flujo de trabajo adaptado culturalmente que supera con creces la
                traducción tradicional. Mediante el uso de soluciones híbridas
                que combinan la agilidad de la IA con la precisión de la
                supervisión humana, las empresas logran una consistencia de
                marca impecable en marketing y formación, garantizando
                subtítulos y doblajes profesionales que cumplen con estándares
                de accesibilidad y mantienen la máxima coherencia tonal en cada
                mercado.
              </p>
              <div
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Ofrecemos el control total para adaptar tus activos a múltiples
              idiomas y culturas. Al centralizar los workflows, no solo reduces
              costes y fricción operativa, sino que aseguras una coherencia de
              marca profesional. Es la solución ideal para empresas que
              necesitan escalar programas de formación y comunicación global con
              la máxima confianza y acabado profesional.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <VideoPortfolio
        videoIds={['wyMLE_um2Sk', 'lHSTqk_1uc4', 'gWnV2XRaUv0']}
      />
