...
const videoProduccionIA =
  typeof videoProduccionIASrc === 'string'
    ? videoProduccionIASrc
    : (videoProduccionIASrc as { src: string }).src;
...
const ProduccionVideoIAPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              Creamos vídeos corporativos y publicitarios con IA combinando
              tecnología avanzada y supervisión humana para escalar contenido en
              web, redes sociales y anuncios sin perder calidad ni coherencia de
              marca. La producción de vídeo es hoy uno de los activos más
              eficaces para generar confianza y aumentar la conversión; al
              integrarse con IA, logramos mayor velocidad, más versiones y un
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                PRODUCCIÓN DE VÍDEO CORPORATIVO PARA{' '}
                <GradientText>WEB, REDES SOCIALES Y ANUNCIOS</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                La producción audiovisual mejora la presencia digital en todos
                los puntos de contacto, desde la web corporativa hasta las
                campañas publicitarias. Gracias a la IA, es posible comunicar
                mensajes complejos de forma clara, adaptar contenidos a
                diferentes formatos sin rehacer la producción y mantener una
                identidad visual homogénea incluso con un alto volumen de
                contenido.
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Producción audiovisual con IA: Tecnología de vanguardia con
                supervisión experta
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Nuestra producción combina narrativa visual estratégica, motion
                graphics y elementos generados con IA, como avatares o escenas
                automatizadas. El objetivo es construir una presencia visual
                consistente y reconocible en todos los mercados, traduciendo la
                identidad de marca en un lenguaje visual adaptable a múltiples
                plataformas.
              </p>
              <div
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              ...
              <GradientText>
                Escalabilidad, ahorro y calidad certificada
              </GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Centralizar tu producción con nosotros permite acceder a
              tecnología de IA avanzada sin inversión inicial, liberando
              recursos internos mientras garantizas una coherencia de marca
              absoluta en todos tus canales. Al combinar una gestión
              centralizada con soluciones de localización y contenido
              multilingüe, transformamos la producción de vídeo en una ventaja
              competitiva real: escalarás tu comunicación rápidamente, reducirás
              drásticamente los costes operativos y obtendrás siempre un
              resultado profesional adaptado a cualquier mercado internacional.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <VideoPortfolio
        videoIds={['tbD-8HViFl4', 'wyMLE_um2Sk', '7Hlge9Q_8iQ']}
      />
