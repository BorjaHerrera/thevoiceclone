...
const sections = [
  {
    ...
    title:
      'Multilingual AI voice over: scalability with global brand consistency',
  ...
  },
  {
    ...
    title:
      'Hybrid methodology: the right balance between AI and professional voice artists',
...
const AiVoicesPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              We scale your content production without losing quality or brand
              consistency. We are not an automatic generator: we manage the
              entire process, from strategic script review to final mastering.
              The result is professional, efficient voice over — fully aligned
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                We make sure your{' '}
                <GradientText>voice sounds perfect.</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Forget configuring parameters. Many companies confuse automatic
                generators with a professional service. While a software tool
                produces only an audio file, our hybrid workflow adapts, refines
                and integrates every voice within your global strategy. At The
                Voice Clone, we unify advanced technology with human editing to
                guarantee credibility, naturalness and real operational savings.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              ...
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Scale your audiovisual production with a solution that optimises
                time and budget for corporate videos, product explainers and
                international communications. Our expert-validated voice
                synthesis technology dramatically reduces studio costs for
                e-learning and internal training content, guaranteeing absolute
                brand consistency without upfront infrastructure investment.
              </p>
              <div
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              The Voice Clone: where AI becomes{' '}
              <GradientText>professional voice over.</GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              Managing voice production internally means learning curves and
              technical costs. By trusting our managed service, you access
              cutting-edge technology and structured workflows with predictable
              costs. We transform audio production into a competitive advantage:
              scale your communications quickly, reduce operational complexity
              and always obtain a certified professional result.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <VideoPortfolio
        videoIds={['yDDZg_Qh4Rs', 'QeDAESHmZBU', 'lHSTqk_1uc4']}
      />
