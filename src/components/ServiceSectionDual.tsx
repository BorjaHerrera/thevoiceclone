...
const copy = {
  es: {
    ...
    subtitle:
      'Los servicios de vídeo y multimedia ayudan a agencias y marcas a producir, adaptar y escalar contenido de manera eficiente para múltiples mercados, preservando el control creativo y la identidad de marca.',
    card1Title: 'Localización de Vídeo',
    card1Body:
      'Procesos híbridos con IA y revisión humana experta para acelerar la distribución internacional manteniendo tono, terminología y consistencia cultural en cada mercado.',
    card2Title: 'Producción de Vídeo',
    card2Body:
      'Producción asistida por IA que reduce costes y tiempos automatizando tareas repetitivas, con expertos validando decisiones creativas y de marca para escalar contenido corporativo.'
  },
  en: {
      ...
      <div className='px-6 md:px-12 lg:px-20 xl:px-32'>
        ...
        <div className='grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto'>
          ...
          >
            ...
            <h3 className='text-3xl md:text-4xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-4'>
              {t.card1Title}
            </h3>
