...
const ServicioTraduccionPage = () => {
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-background'>
        ...
        <div className='container relative z-10 px-4 lg:px-8 pt-36 pb-24 lg:pt-48 lg:pb-36'>
          <div className='max-w-5xl mx-auto text-center'>
            ...
            >
              Garantizamos que tu comunicación global mantenga la precisión y el
              impacto original en cada mercado. No dependemos de motores
              automáticos sin control: combinamos tecnología de IA asistida con
              la revisión de expertos nativos para asegurar una terminología
              uniforme y una adaptación cultural impecable.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className='grid lg:grid-cols-2 gap-10 lg:gap-20 items-start max-w-6xl mx-auto'>
            ...
            >
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight'>
                ...
                <GradientText>protegida en cada idioma.</GradientText>
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              <p className='text-lg text-muted-foreground leading-relaxed'>
                Muchas empresas arriesgan su reputación con traducciones
                automáticas que carecen de contexto y estilo corporativo. En The
                Voice Clone, nuestro flujo híbrido unifica la velocidad
                tecnológica con el criterio humano, logrando un 95% de
                consistencia terminológica y eliminando los errores comunes que
                las herramientas genéricas suelen pasar por alto.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          >
            <div className='max-w-2xl'>
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight text-foreground mb-8'>
                Traducción inteligente y revisión humana: Eficiencia máxima sin
                errores de IA.
              </h2>
              <p className='text-lg text-muted-foreground leading-relaxed mb-6'>
                Optimiza tus presupuestos en{' '}
                <strong>
                  documentación técnica, campañas de marketing y contenido web
                </strong>{' '}
                internacional. Nuestra metodología reduce hasta un 40% los
                errores terminológicos mediante el uso de glosarios
                centralizados y supervisión experta, permitiéndote escalar tu
                presencia global sin comprometer la calidad ni los plazos de
                entrega.
              </p>
              <div
              ...
              {sections.map((section, i) => (
                ...
                >
                  ...
                  {section.subsections.map(
                    (sub: { heading: string; text: string }, j: number) => (
        ...
        <div className='container px-4 lg:px-8 max-w-4xl mx-auto text-center'>
          ...
          >
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold uppercase leading-[1.05] tracking-tight mb-8'>
              Donde la traducción se convierte en un{' '}
              <GradientText>activo de confianza.</GradientText>
            </h2>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              La gestión interna de traducciones suele derivar en
              inconsistencias que dañan la imagen de marca. Al confiar en
              nuestro servicio gestionado, accedes a una infraestructura de
              traducción profesional que garantiza coherencia, rapidez y ahorro
              operativo. Escalamos tu comunicación rápidamente para que tu
              mensaje llegue a cualquier mercado con la máxima fiabilidad.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <VideoPortfolio
        videoIds={['gWnV2XRaUv0', 'lHSTqk_1uc4', 'S17marPSB8g']}
      />
